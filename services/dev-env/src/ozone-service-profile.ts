...
export class OzoneServiceProfile {
  ...
  async createServiceDetails(
    ...
    const serviceJwtRes = await this.thirdPartyPdsClient.com.atproto.server
      .getServiceAuth({
        aud: newServerDid,
    ...
    const getDidCredentials = await pdsClient.com.atproto.identity
      .getRecommendedDidCredentials();

    await this.thirdPartyPdsClient.com.atproto.identity
    ...
    const plcOp = await this.thirdPartyPdsClient.com.atproto.identity
      .signPlcOperation(
        plcOperationData,
      );
