...
import { Code, ConnectError } from "./util.ts";
import { HostList } from "./hosts.ts";
  ...
  private createClient(host: string): DataPlaneClient {
    ...
    return {
      async getIdentityByDid(
        ...
        return {
          did: actor.did,
          keys: decodeBase64(actor.keys),
          services: decodeBase64(actor.services),
