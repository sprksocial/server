...
import PDS, { envToCfg, envToSecrets, httpLogger, readEnv } from ".";
...
async function checkHandleRoute(
  /** @type {PDS} */ pds: PDS,
  /** @type {import('express').Request} */ req: import("express").Request,
  /** @type {import('express').Response} */ res: import("express").Response
) {
  try {
