...
import * as SoSprkSoundGetPostsByAudio from "./types/so/sprk/sound/getPostsByAudio.ts";
...
export class SoSprkSoundNS {
  ...
  getPostsByAudio<A extends Auth = void>(
    cfg: MethodConfigOrHandler<
      A,
      SoSprkSoundGetPostsByAudio.QueryParams,
      SoSprkSoundGetPostsByAudio.HandlerInput,
      SoSprkSoundGetPostsByAudio.HandlerOutput
    >,
  ) {
    const nsid = "so.sprk.sound.getPostsByAudio"; // @ts-ignore - userType.nsid is dynamically generated and TypeScript can't infer its type
    return this._server.xrpc.method(nsid, cfg);
  }
}
