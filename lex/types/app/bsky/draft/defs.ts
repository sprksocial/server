...
export function isDraftWithId<V>(v: V): v is DraftWithId & V {
  return is$typed(v, id, hashDraftWithId);
}

export function validateDraftWithId<V>(
  v: V,
): ValidationResult<DraftWithId & V> {
...
export function isDraft<V>(v: V): v is Draft & V {
  return is$typed(v, id, hashDraft);
}

export function validateDraft<V>(v: V): ValidationResult<Draft & V> {
...
export function isDraftPost<V>(v: V): v is DraftPost & V {
  return is$typed(v, id, hashDraftPost);
}

export function validateDraftPost<V>(v: V): ValidationResult<DraftPost & V> {
...
export function isDraftView<V>(v: V): v is DraftView & V {
  return is$typed(v, id, hashDraftView);
}

export function validateDraftView<V>(v: V): ValidationResult<DraftView & V> {
...
export function isDraftEmbedLocalRef<V>(v: V): v is DraftEmbedLocalRef & V {
  return is$typed(v, id, hashDraftEmbedLocalRef);
}

export function validateDraftEmbedLocalRef<V>(
  v: V,
): ValidationResult<DraftEmbedLocalRef & V> {
...
export function isDraftEmbedCaption<V>(v: V): v is DraftEmbedCaption & V {
  return is$typed(v, id, hashDraftEmbedCaption);
}

export function validateDraftEmbedCaption<V>(
  v: V,
): ValidationResult<DraftEmbedCaption & V> {
...
export function isDraftEmbedImage<V>(v: V): v is DraftEmbedImage & V {
  return is$typed(v, id, hashDraftEmbedImage);
}

export function validateDraftEmbedImage<V>(
  v: V,
): ValidationResult<DraftEmbedImage & V> {
...
export function isDraftEmbedVideo<V>(v: V): v is DraftEmbedVideo & V {
  return is$typed(v, id, hashDraftEmbedVideo);
}

export function validateDraftEmbedVideo<V>(
  v: V,
): ValidationResult<DraftEmbedVideo & V> {
...
export function isDraftEmbedExternal<V>(v: V): v is DraftEmbedExternal & V {
  return is$typed(v, id, hashDraftEmbedExternal);
}

export function validateDraftEmbedExternal<V>(
  v: V,
): ValidationResult<DraftEmbedExternal & V> {
...
export function isDraftEmbedRecord<V>(v: V): v is DraftEmbedRecord & V {
  return is$typed(v, id, hashDraftEmbedRecord);
}

export function validateDraftEmbedRecord<V>(
  v: V,
): ValidationResult<DraftEmbedRecord & V> {
