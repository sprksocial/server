...
import type * as ChatBskyConvoDefs from "../../../chat/bsky/convo/defs.ts";
import type * as ComAtprotoModerationDefs from "../../../com/atproto/moderation/defs.ts";
import type * as AppBskyAgeassuranceDefs from "../../../app/bsky/ageassurance/defs.ts";
import type * as ComAtprotoServerDefs from "../../../com/atproto/server/defs.ts";
...
export interface ModEventTakedown {
  ...
  targetServices?:
    ("appview" | "pds" | (string & globalThis.Record<PropertyKey, never>))[];
...
export interface ScheduledActionView {
  ...
  action: "takedown" | (string & globalThis.Record<PropertyKey, never>);
