...
export const schemaDict = {
            ...
            "properties": {
              ...
              "accounts": {
                ...
                "items": {
                  "type": "ref",
                  "ref":
                    "lex:tools.ozone.signature.findRelatedAccounts#relatedAccount",
                },
              },
            },
          },
            ...
            "properties": {
              ...
              "notifications": {
                ...
                "items": {
                  "type": "ref",
                  "ref":
                    "lex:so.sprk.notification.listNotifications#notification",
                },
              },
              "priority": {
                "type": "boolean",
  ...
  "SoSprkAuthCreatePosts": {
    ...
    "defs": {
      "main": {
        ...
        "title:lang": {},
        "detail":
          "Create Spark posts, replies, stories, and upload media, but can not update or delete them.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthDeleteContent": {
    ...
    "defs": {
      "main": {
        ...
        "title:lang": {},
        "detail":
          "Clean up Spark account history: posts, replies, reposts, likes, thread controls, and stories.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthFullApp": {
    ...
    "defs": {
      "main": {
        ...
        "title:lang": {},
        "detail":
          "Manage Spark content and interactions, private preferences and notifications, and Spark-specific app features and data.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthManageFeedDeclarations": {
    "lexicon": 1,
    "id": "so.sprk.authManageFeedDeclarations",
    "defs": {
      "main": {
        "type": "permission-set",
        "title": "Manage Spark Feed Declarations",
        "title:lang": {},
        "detail": "Configure Spark feed generator declaration records.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthManageLabelerService": {
    "lexicon": 1,
    "id": "so.sprk.authManageLabelerService",
    "defs": {
      "main": {
        "type": "permission-set",
        "title": "Manage Spark Labeler Service",
        "title:lang": {},
        "detail": "Configure Spark labeler declaration records.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthManageProfile": {
    "lexicon": 1,
    "id": "so.sprk.authManageProfile",
    "defs": {
      "main": {
        "type": "permission-set",
        "title": "Manage Spark Profile",
        "title:lang": {},
        "detail": "Update Spark profile data.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
  ...
  "SoSprkAuthViewAll": {
    ...
    "defs": {
      "main": {
        "type": "permission-set",
        "title": "Read-only Access to Spark Content",
        "title:lang": {},
        "detail":
          "View Spark network content from an account perspective, and read notifications and preferences.",
        "detail:lang": {},
        "permissions": [
          {
            "type": "permission",
            ...
            "properties": {
              "codes": {
                ...
                "items": {
                  "type": "ref",
                  "ref":
                    "lex:com.atproto.server.createInviteCodes#accountCodes",
                },
              },
            },
          },
...
export const ids = {
  ...
  SoSprkAuthCreatePosts: "so.sprk.authCreatePosts",
  SoSprkAuthDeleteContent: "so.sprk.authDeleteContent",
  SoSprkAuthFullApp: "so.sprk.authFullApp",
  SoSprkAuthManageFeedDeclarations: "so.sprk.authManageFeedDeclarations",
  SoSprkAuthManageLabelerService: "so.sprk.authManageLabelerService",
  SoSprkAuthManageModeration: "so.sprk.authManageModeration",
  SoSprkAuthManageNotifications: "so.sprk.authManageNotifications",
  SoSprkAuthManageProfile: "so.sprk.authManageProfile",
  SoSprkAuthViewAll: "so.sprk.authViewAll",
