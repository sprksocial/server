...
async function seedTestData(
  ...
  if (options.audio) {
    const audio1 = await models.Audio.create({
      ...
      origin: {
        uri: `at://${TEST_USERS[1].did}/app.sprk.audio/origin1`,
        cid: `${baseCid}origin1`,
      },
      title: "Chill Beats",
      details: { title: "Relaxing music for coding" },
      labels: [],
      useCount: 10,
    });
    ...
    const audio2 = await models.Audio.create({
      ...
      origin: {
        uri: `at://${TEST_USERS[1].did}/app.sprk.audio/origin2`,
        cid: `${baseCid}origin2`,
      },
      title: "Summer Vibes",
      details: { title: "Upbeat summer track" },
      labels: [],
      useCount: 5,
    });
